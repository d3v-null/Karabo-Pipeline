...
class PyHttpx(PythonPackage):
    ...
    with default_args(type=("build", "run")):
        ...
        # Fixed version constraint: was @0.15.2:2.23.3 (typo including 0.27+)
        # Now correctly constrained to @0.15.2:0.23.3
        # Note: httpx 0.27+ doesn't use rfc3986 at all (uses idna directly)
        depends_on("py-rfc3986@1.3:1", when="@0.11.1")
        depends_on("py-rfc3986+idna2008@1.3:1", when="@0.15.2:0.23.3")
